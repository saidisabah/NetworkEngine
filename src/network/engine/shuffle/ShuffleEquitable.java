...
System.out.println("===========================================");
            ...
            while (true) {
                try (Socket socket = serverSocket.accept();
                    ...
                    if (role.startsWith("sender")) {
                        ...
                        Queue<String> receptionQueue = buildFairQueue(plan, senderOrder);
 
                        System.out.println("📜 File de réception équitable (ordre prévu) :");
                        int index = 1;
    ...
    private static Queue<String> buildFairQueue(Map<String, Integer> plan, List<String> senderOrder) {
